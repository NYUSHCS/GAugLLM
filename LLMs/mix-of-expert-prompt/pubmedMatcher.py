...
class CusTransformerMatcher(pecos.BaseClass):
    ...
    def __init__(
        ...
        self.weights_path = "/LLM4GCL_update/LLMs/prt_lm/pubmed/training_weight.emb"
        self.checkpoint_dir = "/LLM4GCL_update/LLMs/checkpoints/pubmed_LLaMA/"
    ...
    def predict(
        ...
        **kwargs,
        ...
        if epoch_index != 0:
            weights_path = f"/LLM4GCL_update/LLMs/checkpoints/pubmed_LLaMA/{epoch_index}/{self.attention_type}-weights.emb"
            ...
            save_path = f"/LLM4GCL_update/LLMs/checkpoints/pubmed_LLaMA/{epoch_index}/{self.attention_type}-embs.emb"
    ...
    def fine_tune_encoder(self, probs, val_prob=None, val_csr_codes=None, save_embedding_for_each_epoch = False):
        ...
        for epoch in range(1, int(train_params.num_train_epochs) + 1):
            ...
            if new_weights.shape == torch.Size([19717, 4]):
