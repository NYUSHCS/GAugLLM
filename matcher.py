...
class CusTransformerMatcher(pecos.BaseClass):
    ...
    def __init__(
        ...
        self.checkpoint_dir = "/LLM4GCL_update/LLMs/checkpoints/pubmed/"
    ...
    def predict(
        ...
        **kwargs,
        ...
        if epoch_index != 0:
            weights_path = f"/LLM4GCL_update/LLMs/checkpoints/pubmed/{epoch_index}/{self.attention_type}-weights.emb"
            ...
            save_path = f"/LLM4GCL_update/LLMs/checkpoints/pubmed/{epoch_index}/{self.attention_type}-embs.emb"
