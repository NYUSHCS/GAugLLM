...
#from matcherori import TransformerMatcher
from pecos.xmc.xtransformer import TransformerMatcher
    ...
    def train(
        ...
        **kwargs,
        ...
        if not train_params.do_fine_tune:
            ...
            print(pred_params)
            pred_params = XTransformer.PredParams(matcher_params_chain=[TransformerMatcher.PredParams(only_topk=20, post_processor='l3-hinge', ensemble_method='transformer-only', truncate_length=128), TransformerMatcher.PredParams(only_topk=20, post_processor='l3-hinge', ensemble_method='transformer-only', truncate_length=128), TransformerMatcher.PredParams(only_topk=20, post_processor='l3-hinge', ensemble_method='transformer-only', truncate_length=128)], ranker_params=XLinearModel.PredParams(hlm_args=HierarchicalMLModel.PredParams(model_chain=MLModel.PredParams(only_topk=20, post_processor='l3-hinge'))))
            LOGGER.debug(
            ...
            #print("length of train_params.matcher_params_chain",len(train_params.matcher_params_chain))
