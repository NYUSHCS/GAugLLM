...
from pecos.xmc.base import HierarchicalMLModel, HierarchicalKMeans,MLModel
from pecos.xmc.xlinear.model import XLinearModel
#from pecos.xmc.xtransformer.matcher import TransformerMatcher
from arxivMatcher import CusTransformerMatcher
from pecos.xmc.xtransformer.module import MLProblemWithText

LOGGER = logging.getLogger(__name__)


class CustomXTransformer(pecos.BaseClass):
    ...
    class TrainParams(pecos.BaseParams):
        ...
        matcher_params_chain: CusTransformerMatcher.TrainParams = None  # type: ignore
    ...
    class PredParams(pecos.BaseParams):
        ...
        matcher_params_chain: CusTransformerMatcher.PredParams = None  # type: ignore
    ...
    def load(cls, load_dir, **xrl_kwargs):
        ...
        text_encoder = CusTransformerMatcher.load(load_dir)
        try:
        ...
        **kwargs,
        ...
        if not train_params.do_fine_tune:
            ...
            if matcher_train_params.init_model_dir:
                parent_model = CusTransformerMatcher.load(matcher_train_params.init_model_dir)
                LOGGER.info("Loaded encoder from {}.".format(matcher_train_params.init_model_dir))
            else:
                parent_model = CusTransformerMatcher.download_model(
            ...
            #set train_params
            #train_params = CustomXTransformer.TrainParams(preliminary_indexer_params=HierarchicalKMeans.TrainParams(nr_splits=4, min_codes=32, max_leaf_size=100, spherical=True, seed=12345, kmeans_max_iter=20, threads=-1, do_sample=False, max_sample_rate=1.0, min_sample_rate=0.1, warmup_ratio=0.4), refined_indexer_params=HierarchicalKMeans.TrainParams(nr_splits=4, min_codes=32, max_leaf_size=100, spherical=True, seed=12345, kmeans_max_iter=20, threads=-1, do_sample=False, max_sample_rate=1.0, min_sample_rate=0.1, warmup_ratio=0.4), matcher_params_chain=[CusTransformerMatcher.TrainParams(model_shortcut='roberta-base', negative_sampling='tfn+man', loss_function='weighted-squared-hinge', bootstrap_method='linear', lr_schedule='linear', threshold=0.0, hidden_dropout_prob=0.05, batch_size=32, batch_gen_workers=2, max_active_matching_labels=1000, max_num_labels_in_gpu=65536, max_steps=2500, max_no_improve_cnt=-1, num_train_epochs=5, gradient_accumulation_steps=1, weight_decay=0, max_grad_norm=1.0, learning_rate=6e-05, adam_epsilon=1e-08, warmup_steps=200, logging_steps=200, save_steps=2500, cost_sensitive_ranker=False, pre_tokenize=True, pre_tensorize_labels=True, use_gpu=True, eval_by_true_shorlist=False, checkpoint_dir='', cache_dir='', init_model_dir=''), CusTransformerMatcher.TrainParams(model_shortcut='roberta-base', negative_sampling='tfn+man', loss_function='weighted-squared-hinge', bootstrap_method='linear', lr_schedule='linear', threshold=0.0, hidden_dropout_prob=0.05, batch_size=32, batch_gen_workers=2, max_active_matching_labels=1000, max_num_labels_in_gpu=65536, max_steps=2500, max_no_improve_cnt=-1, num_train_epochs=5, gradient_accumulation_steps=1, weight_decay=0, max_grad_norm=1.0, learning_rate=6e-05, adam_epsilon=1e-08, warmup_steps=200, logging_steps=200, save_steps=2500, cost_sensitive_ranker=False, pre_tokenize=True, pre_tensorize_labels=True, use_gpu=True, eval_by_true_shorlist=False, checkpoint_dir='', cache_dir='', init_model_dir=''), CusTransformerMatcher.TrainParams(model_shortcut='roberta-base', negative_sampling='tfn+man', loss_function='weighted-squared-hinge', bootstrap_method='linear', lr_schedule='linear', threshold=0.0, hidden_dropout_prob=0.05, batch_size=32, batch_gen_workers=2, max_active_matching_labels=1000, max_num_labels_in_gpu=65536, max_steps=2500, max_no_improve_cnt=-1, num_train_epochs=5, gradient_accumulation_steps=1, weight_decay=0, max_grad_norm=1.0, learning_rate=6e-05, adam_epsilon=1e-08, warmup_steps=200, logging_steps=200, save_steps=2500, cost_sensitive_ranker=False, pre_tokenize=True, pre_tensorize_labels=True, use_gpu=True, eval_by_true_shorlist=False, checkpoint_dir='', cache_dir='', init_model_dir='')], ranker_params=XLinearModel.TrainParams(mode='full-model', ranker_level=1, nr_splits=16, min_codes=None, shallow=False, rel_mode='disable', rel_norm='no-norm', hlm_args=HierarchicalMLModel.TCusTransformerMatcherrainParams(neg_mining_chain='tfn', model_chain=MLModel.TrainParams(threshold=0.0, max_nonzeros_per_label=None, solver_type='L2R_L2LOSS_SVC_DUAL', Cp=1.0, Cn=1.0, max_iter=100, eps=0.1, bias=1.0, threads=-1, verbose=3, newton_eps=0.01))), do_fine_tune=True, only_encoder=True, fix_clustering=False, max_match_clusters=2048)
            train_params = CustomXTransformer.TrainParams(preliminary_indexer_params=HierarchicalKMeans.TrainParams(nr_splits=4, min_codes=32, max_leaf_size=100, spherical=True, seed=12345, kmeans_max_iter=20, threads=-1, do_sample=False, max_sample_rate=1.0, min_sample_rate=0.1, warmup_ratio=0.4), refined_indexer_params=HierarchicalKMeans.TrainParams(nr_splits=4, min_codes=32, max_leaf_size=100, spherical=True, seed=12345, kmeans_max_iter=20, threads=-1, do_sample=False, max_sample_rate=1.0, min_sample_rate=0.1, warmup_ratio=0.4), matcher_params_chain=[CusTransformerMatcher.TrainParams(model_shortcut='roberta-base', negative_sampling='tfn+man', loss_function='weighted-squared-hinge', bootstrap_method='linear', lr_schedule='linear', threshold=0.0, hidden_dropout_prob=0.05, batch_size=32, batch_gen_workers=2, max_active_matching_labels=1000, max_num_labels_in_gpu=65536, max_steps=2500, max_no_improve_cnt=-1, num_train_epochs=10, gradient_accumulation_steps=1, weight_decay=0, max_grad_norm=1.0, learning_rate=6e-05, adam_epsilon=1e-08, warmup_steps=200, logging_steps=200, save_steps=2500, cost_sensitive_ranker=False, pre_tokenize=True, pre_tensorize_labels=True, use_gpu=True, eval_by_true_shorlist=False, checkpoint_dir='', cache_dir='', init_model_dir=''), CusTransformerMatcher.TrainParams(model_shortcut='roberta-base', negative_sampling='tfn+man', loss_function='weighted-squared-hinge', bootstrap_method='linear', lr_schedule='linear', threshold=0.0, hidden_dropout_prob=0.05, batch_size=32, batch_gen_workers=2, max_active_matching_labels=1000, max_num_labels_in_gpu=65536, max_steps=2500, max_no_improve_cnt=-1, num_train_epochs=10, gradient_accumulation_steps=1, weight_decay=0, max_grad_norm=1.0, learning_rate=6e-05, adam_epsilon=1e-08, warmup_steps=200, logging_steps=200, save_steps=2500, cost_sensitive_ranker=False, pre_tokenize=True, pre_tensorize_labels=True, use_gpu=True, eval_by_true_shorlist=False, checkpoint_dir='', cache_dir='', init_model_dir=''), CusTransformerMatcher.TrainParams(model_shortcut='roberta-base', negative_sampling='tfn+man', loss_function='weighted-squared-hinge', bootstrap_method='linear', lr_schedule='linear', threshold=0.0, hidden_dropout_prob=0.05, batch_size=32, batch_gen_workers=2, max_active_matching_labels=1000, max_num_labels_in_gpu=65536, max_steps=2500, max_no_improve_cnt=-1, num_train_epochs=10, gradient_accumulation_steps=1, weight_decay=0, max_grad_norm=1.0, learning_rate=6e-05, adam_epsilon=1e-08, warmup_steps=200, logging_steps=200, save_steps=2500, cost_sensitive_ranker=False, pre_tokenize=True, pre_tensorize_labels=True, use_gpu=True, eval_by_true_shorlist=False, checkpoint_dir='', cache_dir='', init_model_dir=''), CusTransformerMatcher.TrainParams(model_shortcut='roberta-base', negative_sampling='tfn+man', loss_function='weighted-squared-hinge', bootstrap_method='linear', lr_schedule='linear', threshold=0.0, hidden_dropout_prob=0.05, batch_size=32, batch_gen_workers=2, max_active_matching_labels=1000, max_num_labels_in_gpu=65536, max_steps=2500, max_no_improve_cnt=-1, num_train_epochs=10, gradient_accumulation_steps=1, weight_decay=0, max_grad_norm=1.0, learning_rate=6e-05, adam_epsilon=1e-08, warmup_steps=200, logging_steps=200, save_steps=2500, cost_sensitive_ranker=False, pre_tokenize=True, pre_tensorize_labels=True, use_gpu=True, eval_by_true_shorlist=False, checkpoint_dir='', cache_dir='', init_model_dir='')], ranker_params=XLinearModel.TrainParams(mode='full-model', ranker_level=1, nr_splits=16, min_codes=None, shallow=False, rel_mode='disable', rel_norm='no-norm', hlm_args=HierarchicalMLModel.TrainParams(neg_mining_chain='tfn', model_chain=MLModel.TrainParams(threshold=0.0, max_nonzeros_per_label=None, solver_type='L2R_L2LOSS_SVC_DUAL', Cp=1.0, Cn=1.0, max_iter=100, eps=0.1, bias=1.0, threads=-1, verbose=3, newton_eps=0.01))), do_fine_tune=True, only_encoder=True, fix_clustering=False, max_match_clusters=2048)
            LOGGER.debug(
            ...
            #set pred_params
            #pred_params = CustomXTransformer.PredParams(matcher_params_chain=[CusTransformerMatcher.PredParams(only_topk=20, post_processor='l3-hinge', ensemble_method='transformer-only', truncate_length=128), CusTransformerMatcher.PredParams(only_topk=20, post_processor='l3-hinge', ensemble_method='transformer-only', truncate_length=128), CusTransformerMatcher.PredParams(only_topk=20, post_processor='l3-hinge', ensemble_method='transformer-only', truncate_length=128)], ranker_params=XLinearModel.PredParams(hlm_args=HierarchicalMLModel.PredParams(model_chain=MLModel.PredParams(only_topk=20, post_processor='l3-hinge'))))
            pred_params = CustomXTransformer.PredParams(matcher_params_chain=[CusTransformerMatcher.PredParams(only_topk=20, post_processor='l3-hinge', ensemble_method='transformer-only', truncate_length=128), CusTransformerMatcher.PredParams(only_topk=20, post_processor='l3-hinge', ensemble_method='transformer-only', truncate_length=128), CusTransformerMatcher.PredParams(only_topk=20, post_processor='l3-hinge', ensemble_method='transformer-only', truncate_length=128), CusTransformerMatcher.PredParams(only_topk=20, post_processor='l3-hinge', ensemble_method='transformer-only', truncate_length=128)], ranker_params=XLinearModel.PredParams(hlm_args=HierarchicalMLModel.PredParams(model_chain=MLModel.PredParams(only_topk=20, post_processor='l3-hinge'))))
            LOGGER.debug(
            ...
            for i in range(nr_transformers):
                print(f"Total training {nr_transformers} times. No.{i+1}th this round ")
                ...
                if i == nr_transformers - 1:
                    return_pred_on_trn = not train_params.only_encoder
                else:
                ...
                if i == nr_transformers - 1:
                    save_embedding_for_each_epoch = True
                else:
                    save_embedding_for_each_epoch = False

                res_dict = CusTransformerMatcher.train(
                    cur_probs,
                    csr_codes=M_pred,
                    ...
                    save_embedding_for_each_epoch = save_embedding_for_each_epoch,
        ...
        if not train_params.only_encoder:
            # construct X_concat
            X_concat = CusTransformerMatcher.concat_features(
                prob.X_feat,
                inst_embeddings,
                normalize_emb=True,
            )
