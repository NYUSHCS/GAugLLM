...
from historyModel import CustomXTransformer
...
class GiantTrainer_new():
    def __init__(self,data,text,filename,device):
        ...
        self.checkpoints_dir = f'checkpoints/amazon-history/'
        ...
        with open('/LLM4GCL_update/LLMs/prt_lm/amazon-history/Aug_degrees_list.json', 'w') as f:
